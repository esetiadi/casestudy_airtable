...
document.getElementById("gallery-button").addEventListener("click",function(e) { $('#gallery').insertBefore($('.perfect-jumbotron').children()[0]);})

document.getElementById("form-button").addEventListener("click",function(e) { $('#form').insertBefore($('.perfect-jumbotron').children()[0]);})
